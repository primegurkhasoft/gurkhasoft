...
// Create the MouseEnterContext with a proper default value
const MouseEnterContext = createContext<MouseEnterContextType | undefined>(undefined);

// Define the types for the CardContainer props
...
// Define the types for the CardBody props
...
// Define the types for the CardItem props
